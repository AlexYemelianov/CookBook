        ...
        return <div className="search">
            ...
            {this.state.searchedRecaipes.length !== 0 ?
                <div className="row justify-content-around">
                    {this.state.RecipeName !== "" ? <RecipeShort Recipes={this.state.searchedRecaipes} clickRecipe={this.props.clickRecipe} /> : <p>Без результату</p>}
                </div> : <p>Без результату</p>}

            <Link to="/"><button className="btnAdd btn btn-primary currBtn">Назад</button></Link>
        </div>
